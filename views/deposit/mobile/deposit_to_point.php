	...
	?>
		<div class="credit">
			<div class="credit_method">
				<div><?php echo $this->cbconfig->item('deposit_name'); ?> <span class="textblue"><?php echo number_format((int) $this->member->item('total_deposit')); ?><?php echo $this->cbconfig->item('deposit_unit'); ?></span>중, <input type="number" class="input px100" id="deposit" name="deposit" value="0" onkeydown="if (event.keyCode ==13) return false;" onkeyup="num_deposit_to_point()" /><?php echo $this->cbconfig->item('deposit_unit'); ?> 전환</div>
			</div>
			<div class="credit_method">
