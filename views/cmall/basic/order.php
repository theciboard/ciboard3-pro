	...
	<table class="table">
		<tr>
			...
			?>
				<br /><br />
				보유
				<?php echo html_escape($this->cbconfig->item('deposit_name')); ?> : (<?php echo number_format((int) $this->member->item('total_deposit'));?>
				<?php echo html_escape($this->cbconfig->item('deposit_unit')); ?>)중
				최대
				<?php
