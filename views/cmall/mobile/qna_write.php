	...
	<div class="form-horizontal mt20">
		...
		?>
			...
			<div class="form-group mt20">
				...
				<div class="col-sm-10">
					<?php echo display_dhtml_editor('cqa_content', set_value('cqa_content', element('cqa_content', element('data', $view))), $classname = 'dhtmleditor', $is_dhtml_editor = $this->cbconfig->item('use_cmall_product_qna_dhtml'), $editor_type = $this->cbconfig->item('cmall_product_qna_editor_type')); ?>
				</div>
			</div>
